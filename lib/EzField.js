...
var EzField = function (props) {
    ...
    var toggleClass = toggleCss ? classes.toggle + " " + toggleCss : classes.toggle;
    var fileCss = css.file || props.fileCss || '';
    var fileClass = fileCss ? classes.toggle + " " + fileCss : classes.file;
    ...
    return (React.createElement("div", { className: classes.group },
        props.toggle ? (React.createElement(React.Fragment, null,
            React.createElement(Label, null),
            React.createElement(EzToggle, { name: fieldName, value: props.value, onChange: props.onChange, className: props.inline ? toggleClass + "-inline" : toggleClass }))) : props.file ? (React.createElement(React.Fragment, null,
            React.createElement(Label, null),
            React.createElement(FileUpload, { label: labelText, name: fieldName, value: props.value, onChange: props.onChange, withPreview: props.withPreview, className: fileClass + " " + (hasErrors ? classes.invalidControl : '') }))) : props.checkbox ? (React.createElement(Checkbox, { label: labelText, name: fieldName, value: props.value, onChange: props.onChange })) : props.radio ? (React.createElement(Radio, { label: labelText, name: fieldName, value: props.value, onChange: props.onChange })) : (props.radios && props.options) ? (React.createElement(React.Fragment, null,
            React.createElement(Label, null),
