...
var EzField = function (props) {
    ...
    return (React.createElement("div", { className: classes.group },
        props.checkbox ? (React.createElement(Checkbox, { label: label, name: fieldName, value: props.value })) : props.radio ? (React.createElement(Radio, { label: label, name: fieldName, value: props.value })) : (props.radios && props.options) ? (React.createElement(React.Fragment, null,
            React.createElement("label", { htmlFor: fieldName, className: labelClass }, label),
            React.createElement("div", { className: "ez-field-full " + (hasErrors ? classes.invalidControl : '') }, props.options.map(function (opt) { return (React.createElement(Radio, { key: opt.value, label: opt.label, name: fieldName, value: opt.value })); })))) : (props.checkboxes && props.options) ? (React.createElement(React.Fragment, null,
            React.createElement("label", { htmlFor: fieldName, className: labelClass }, label),
            React.createElement("div", { className: "ez-field-full " + (hasErrors ? classes.invalidControl : '') }, props.options.map(function (opt) { return (React.createElement(Checkbox, { key: opt.value, label: opt.label, name: fieldName, value: opt.value })); })))) : (React.createElement(React.Fragment, null,
            React.createElement("label", { htmlFor: fieldName, className: labelClass }, label),
