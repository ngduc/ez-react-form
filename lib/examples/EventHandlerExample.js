...
var default_1 = /** @class */ (function (_super) {
    ...
    function default_1() {
        ...
        _this.renderForm = function (props) {
            ...
            return (React.createElement(EzForm_1["default"], { use: "bootstrap" },
                React.createElement(EzField_1["default"], { onChange: Utils_2.log('email - onChange') }, "Email | email"),
                React.createElement(EzField_1["default"], { radios: true, options: exports.genders, onChange: Utils_2.log('radios - onChange') }, "Gender | gender"),
                React.createElement(EzField_1["default"], { checkboxes: true, options: Utils_2.roles, onChange: Utils_2.log('checkboxes - onChange') }, "Role(s) | roles"),
