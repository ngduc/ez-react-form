...
var default_1 = /** @class */ (function (_super) {
    ...
    function default_1() {
        ...
        _this.renderForm = function (props) { return (React.createElement(EzForm_1["default"], { use: "bootstrap" },
            ...
            React.createElement(EzField_1["default"], { radios: true, options: Utils_1.genders }, "Gender | gender"),
            React.createElement(EzField_1["default"], { select: true, options: Utils_1.animals }, "Favorite Animal | animal"),
            React.createElement(EzField_1["default"], { checkboxes: true, options: Utils_1.roles }, "Role(s) | roles"),
